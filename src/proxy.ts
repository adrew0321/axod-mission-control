...
export const config = {
  matcher: [
     ...
     *     /api/companion/room-event, /api/companion/writeback,
     *     /api/companion/writeback/list
     ...
     */
    '/((?!login$|api/auth/|api/companion/(?:stream|result|ingest|room-event|writeback(?:/list)?)$|api/health$|_next/|favicon\\.ico|sitemap\\.xml|robots\\.txt|.*\\..*).*)',
  ],
};
